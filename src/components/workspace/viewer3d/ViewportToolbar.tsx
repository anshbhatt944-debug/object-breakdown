    ...
    <div className="hidden md:flex absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex-col items-center gap-2 w-[95%] sm:w-[92%] max-w-2xl pointer-events-none">
      ...
      <div className={`pointer-events-auto flex items-center gap-2 sm:gap-3 px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded w-full border shadow-xl transition-colors duration-200 ${
        ...
        <button
          ...
          className={`px-2 sm:px-2.5 py-1.5 sm:py-1 rounded text-[10px] sm:text-[11px] font-mono-cad font-semibold transition-all flex items-center gap-1 sm:gap-1.5 shrink-0 touch-manipulation min-h-[36px] sm:min-h-0 ${
            isExploded
              ? theme === 'light'
        ...
        <button
          ...
          className={`px-2 sm:px-2.5 py-1.5 sm:py-1 rounded transition-all flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-[11px] font-mono-cad font-medium shrink-0 touch-manipulation min-h-[36px] sm:min-h-0 ${
            isPlayingMechanism
              ? theme === 'light'
                ? 'bg-orange-50 text-[#c2410c] border border-orange-200'
                : 'bg-[rgba(226,114,40,0.15)] text-[#e27228] border border-[rgba(226,114,40,0.5)] shadow-[0_0_10px_rgba(226,114,40,0.2)]'
      ...
      <div className={`pointer-events-auto flex items-center gap-1 p-1 rounded border shadow-xl overflow-x-auto no-scrollbar max-w-full transition-colors duration-200 ${
        ...
        <button
          ...
          className={`px-2 sm:px-2.5 py-1.5 sm:py-1 rounded text-[10px] sm:text-[11px] font-mono-cad flex items-center gap-1 sm:gap-1.5 transition-all touch-manipulation whitespace-nowrap min-h-[36px] sm:min-h-0 ${
            viewMode === 'solid'
              ? theme === 'light'
